...
**<span id="practice2">浏览器是原生支持base 64编码和解码的</span>**
...
**<span id="practice3">class与普通构造函数有什么区别?</span>**
- class在语法上更加贴合面向对象的写法(class可以说是构造函数的语法糖)
- class在实现继承上更加易读也更加容易理解
- 本质上还是语法糖，还是使用prototype
- class的本质还是函数

**<span id="practice4">再谈undefined和null的区别</span>**
...
**<span id="practice5">Vue的父组件和子组件的生命周期钩子的执行顺序是什么?</span>**
- 加载渲染过程
...
**<span id="practice6">doctype的作用是什么?一共有多少种?</span>**
...
**<span id="practice7">for循环的三种使用方式</span>**
```
...
**<span id="practice8">redux中的reducer为什么最好用纯函数来编写?</span>**
**那么问题来了，什么是纯函数?**</br>
1.相同的输入永远返回相同的输出</br>
2.不修改函数的参数值</br>
3.不依赖外部环境</br>
...
**<span id="practice9">箭头函数和普通函数有什么区别?普通构造函数可以使用new，箭头函数可以吗?</span>**
...
**<span id="practice10">内置类之Array</span>**
...
1. 用来控制所描述的属性，如果一个属性的enumerable为false，那么下面三个操作取不到该属性：
  ...
  * Object.keys()
  * JSON.stringify()
2. 补充：Object.defineProperty() 方法会直接在一个对象上定义一个新属性，或者修改一个对象的现有属性， 并返回这个对象。
3. 表示能否通过for...in循环返回属性

**<span id="practice12">对象属性行为之configurable</span>**
1. 表示能否通过delete删除属性从而重新定义属性
2. 一旦该属性值为false，除了writable之外，其他所有的属性都无法在修改
3. 此时把enumerable设置为true，仍然可以通过for...in遍历到该对象的该属性
